...
export default function CreateGoalPage() {
    return (
        <div className="space-y-8">
            ...
            <form action={createGoal} className="space-y-6 max-w-3xl border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm bg-white dark:bg-zinc-900">
                ...
                <div className="flex items-center justify-end gap-3 pt-4">
                    <button type="button" className="rounded-xl px-6 py-3 font-medium text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800">
                        Cancel
                    </button>
